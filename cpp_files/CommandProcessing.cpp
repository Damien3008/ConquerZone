...
Command* CommandProcessor::readCommand() {
	...
	if (commandstr == "loadmap") {
		...
		string temp1;
		int listSize1;
		cout << "Please select the number of maps you wish to add (You can only select 1 to 5 maps): ";
		cin >> listSize1;
		cout << '\n';

		while (listSize1 < 1 || listSize1>5) {
			
			cout << "Incorrect input. Please select the number of maps you wish to add: ";
			cin >> listSize1;
			cout << '\n';
		}
		
		cout << "Insert the map files you wish to add: ";
		cout << '\n';
		...
		string temp2;
		int listSize2;
		cout << "Please select the number of player strategies you wish to add (You can only select 2 to 4 strategies): ";
		cin >> listSize2;
		cout << '\n';
		while (listSize2 < 2 || listSize2 > 4) {
			
			cout << "Incorrect input. Please select the number of player strategies you wish to add: ";
			cin >> listSize2;
			cout << '\n';
		}

		cout << "Insert the player strategies you wish to add: ";
		cout << '\n';
        ...
        cout << "Enter the number of games you wish to play on each map (You can select 1 to 5 games): ";
		int games;
		cin >> games;
		cout << '\n';
		...
		while (games < 1 || games > 5) {
			...
			cout << "Incorrect input. Please enter the number of games you wish to play on each map: ";
			cin >> games;
			cout << '\n';
        ...
        cout << "Finally, enter the max number of turns for each game (You can select 10 to 50 turns): ";
		int turns;
		cin >> turns; 
		cout << '\n';
		...
		while (turns < 10 || turns > 50) {
			...
			cout << "Incorrect input. Please enter the max number of turns for each game: ";
			cin >> turns;
			cout << '\n';
...
bool CommandProcessor::getCommand(GameEngine* game, CommandProcessor* cmd) {
	bool valid = false;
